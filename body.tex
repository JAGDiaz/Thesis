...
of the data, it can give us an idea of how small a window each possible weight can exist in.
...
Considering that the weight matrices are used in the model for linear transformations the hidden layers 
...
of information change. Such classifiers are all over the modern literature of ML and would be of great interest 
and a method for determining good training during training would be of immense utility.
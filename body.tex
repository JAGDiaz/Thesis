...
apples to apples comparison, we make the assumption that consecutive densities have that same support
...
how the information is changing with respect to the steady state. 
...
multiple trainings with latent dimensions ranging from $N_O = 2$ to $N_0 = 15$, the algorithm detailed 
...
Duffing Oscillator that were left unchanged for each run. Figure \ref{fig:duffing slopes and losses}
shows the average and variance of the slopes of 
\begin{figure}[ht]
    \centering
    \begin{minipage}{\textwidth}

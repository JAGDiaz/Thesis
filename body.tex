...
Machine Learning. The ultimate goal of this thesis is to show that we have
...
\begin{figure}[ht]
    ...
    hidden layer has 16 neurons. This representation is meaningful, but it is missing some key 
    network features like the activation functions for each layer.}
